...
class Forge(Room):
    def __init__(self, name):
        ...
        self.craft_list = Resources.get_many_by_type('Weapon', requires_being_craftable=True)
        self.craft_list.update(Resources.get_many_by_type('Armor', requires_being_craftable=True))
        self.craft_list.update(Resources.get_many_by_type('Appearance', requires_being_craftable=True))
    ...
    def parse_options(self, selection, player):
        ...
        selection = selection.replace("Forge","")
